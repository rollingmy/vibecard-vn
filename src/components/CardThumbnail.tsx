...
const CardThumbnail: React.FC<CardThumbnailProps> = ({ template }) => {
    ...
    switch (template.id) {
        case 'flex-den-hoi-tho-cuoi':
            mockName = "VIBE THỦ CHIẾN";
            break;
        case 'dai-gia-ngam':
            mockName = "CHỦ TỊCH GIẢ KHỔ";
            break;
        case 'co-dat-dai-gia':
            mockName = "ĐẠI GIA BĐS";
            break;
        case 'the-black-card':
            mockName = "THIẾU GIA NGẦM";
            break;
        case 'rich-kid-tu-than':
            mockName = "KID TỰ THÂN";
            break;
        case 'tap-doan-da-cap':
            mockName = "DIAMOND LEADER";
            break;
        case 'shark-tank-deal':
            mockName = "STARTUP TRIỆU ĐÔ";
            break;
        case 'nha-suu-tap-xe':
            mockName = "DÂN TỔ LÁI";
            break;
        case 'king-of-bitcoin':
            mockName = "HODLER CHÂN CHÍNH";
            break;
        case 'chien-than-san-sale':
            mockName = "THÁNH CHỐT ĐƠN";
            break;
        case 'simp-lord':
            mockName = "SIMP CHÚA";
            break;
        ...
        <div className="w-full h-full select-none pointer-events-none bg-white">
            ...
            >
                {(() => {
                    switch (template.id) {
                        // ===================================
                        // 1. FLEX ĐẾN HƠI THỞ CUỐI (Banking App)
                        // ===================================
                        case 'flex-den-hoi-tho-cuoi':
                            return (
                                <>
                                    <defs>
                                        <clipPath id={`avatar-clip-faceid-${template.id}`}>
                                            <rect x="95" y="165" width="110" height="110" rx="25" />
                                        </clipPath>
                                        <linearGradient id={`bank-grad-${template.id}`} x1="0%" y1="0%" x2="100%" y2="100%">
                                    ...
                                    <rect width="300" height="400" fill={`url(#bank-grad-${template.id})`} />
                                    ...
                                    <text x="150" y="320" textAnchor="middle" fill="white" fontWeight="bold" fontSize={20}>
                                        {mockName}
                                    </text>
                        ...
                        // ===================================
                        // 2. ĐẠI GIA NGẦM (Gold Cardvisit)
                        // ===================================
                        case 'dai-gia-ngam':
                            return (
                                <>
                                    <defs>
                                        <filter id={`grain-${template.id}`}>
                                            <feTurbulence type="fractalNoise" baseFrequency="0.8" numOctaves="3" stitchTiles="stitch" />
                                        </filter>
                                        <clipPath id={`avatar-clip-oval-${template.id}`}>
                                    ...
                                    <rect width="300" height="400" filter={`url(#grain-${template.id})`} opacity="0.2" style={{ mixBlendMode: "multiply" }} />
                        ...
                        // ===================================
                        // 3. CÒ ĐẤT ĐẠI GIA (Sổ Đỏ)
                        // ===================================
                        case 'co-dat-dai-gia':
                            return (
                                <>
                                    <defs>
                                        <clipPath id={`avatar-clip-rect-${template.id}`}>
                                            <rect x="75" y="140" width="150" height="180" />
                                        </clipPath>
                                        <pattern id={`guilloche-${template.id}`} width="40" height="40" patternUnits="userSpaceOnUse">
                                    ...
                                    <rect width="300" height="400" fill={`url(#guilloche-${template.id})`} />
                                    ...
                                    <text x="150" y="350" textAnchor="middle" fontWeight="900" fontSize={24} fill="#8B0000" style={{ textTransform: "uppercase" }}>
                                        {mockName}
                                    </text>
                        ...
                        // ===================================
                        // 4. THE BLACK CARD (Credit)
                        // ===================================
                        case 'the-black-card':
                            return (
                                <>
                                    <defs>
                                        <linearGradient id={`silver-grad-${template.id}`} x1="0%" y1="0%" x2="100%" y2="100%">
                                            <stop offset="0%" stopColor="#C0C0C0" />
                                            <stop offset="50%" stopColor="#E8E8E8" />
                                            <stop offset="100%" stopColor="#A9A9A9" />
                                        </linearGradient>
                                        <clipPath id={`avatar-clip-chip-${template.id}`}>
                                    ...
                                    {/* Silver Header */}
                                    <text x="20" y="40" fontFamily="sans-serif" fontSize="14" fill={`url(#silver-grad-${template.id})`} fontStyle="italic" fontWeight="bold">AMERICAN FLEX</text>
                                    ...
                                    <text x="30" y="340" textAnchor="start" fontWeight="900" fontSize={Math.min(nameFontSize + 4, 30)} fill={`url(#silver-grad-${template.id})`} letterSpacing="1" style={{ textShadow: "1px 1px 2px black" }}>
                                        {mockName}
                                    </text>

                                    {/* Embossed Numbers */}
                                    <text x="150" y="380" textAnchor="middle" fontFamily="monospace" fontSize="20" fill={`url(#silver-grad-${template.id})`} letterSpacing="2" style={{ textShadow: "1px 1px 2px black" }}>
                                        0000 0000 0000 FLEX
                                    </text>
                        ...
                        // ===================================
                        // 5. RICH KID TỰ THÂN (Luxury Box)
                        // ===================================
                        case 'rich-kid-tu-than':
                            return (
                                <>
                                    <defs>
                                        <clipPath id={`avatar-clip-diamond-${template.id}`}>
                                    ...
                                    <text x="150" y="360" textAnchor="middle" fontWeight="900" fontSize={20} fill="black" style={{ textTransform: "uppercase" }}>
                                        {mockName}
                                    </text>
                                </>
                            );
                            ...
                            return (
                                <>
                                    ...
                                    <g transform="translate(130, 120)">
                                        ...
                                        <text x="0" y="35" fontSize={14} fontWeight="bold">{mockName}</text>
                        ...
                        // ===================================
                        // 6. TẬP ĐOÀN ĐA CẤP (Pyramid)
                        // ===================================
                        case 'tap-doan-da-cap':
                            return (
                                <>
                                    <defs>
                                        <clipPath id={`avatar-clip-pyramid-${template.id}`}>
                                            <circle cx="150" cy="110" r="50" />
                                        </clipPath>
                                        <linearGradient id={`blue-grad-${template.id}`} x1="0%" y1="0%" x2="0%" y2="100%">
                                    ...
                                    <rect width="300" height="400" fill={`url(#blue-grad-${template.id})`} />
                                    ...
                                    <text x="150" y="240" textAnchor="middle" fill="black" fontWeight="900" fontSize={24} style={{ textTransform: "uppercase" }}>
                                        {mockName}
                                    </text>
                        ...
                        case 'shark-tank-deal':
                            return (
                                <>
                                    <defs>
                                        <clipPath id={`avatar-clip-stamp-${template.id}`}>
                                    ...
                                    <text x="40" y="190" fontFamily="serif" fontStyle="italic" fontWeight="900" fontSize={26} fill="black">
                                        {mockName}
                                    </text>
                                    ...
                                    <text x="250" y="55" textAnchor="middle" fontSize="20">🦈</text>
                                </>
                            );
                        ...
                        case 'nha-suu-tap-xe':
                            return (
                                <>
                                    <defs>
                                        <clipPath id={`avatar-clip-circle-${template.id}`}>
                                            <circle cx="150" cy="150" r="70" />
                                        </clipPath>
                                        <linearGradient id={`carbon-grad-${template.id}`} x1="0%" y1="0%" x2="100%" y2="100%">
                                            <stop offset="0%" stopColor="#1a1a1a" />
                                    ...
                                    {/* Carbon Fiber BG */}
                                    <rect width="300" height="400" fill={`url(#carbon-grad-${template.id})`} />
                                    <pattern id={`carbon-patt-${template.id}`} width="10" height="10" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
                                        <rect width="5" height="5" fill="black" opacity="0.5" />
                                        <rect x="5" y="5" width="5" height="5" fill="black" opacity="0.5" />
                                    </pattern>
                                    <rect width="300" height="400" fill={`url(#carbon-patt-${template.id})`} />
                                    ...
                                    <text x="150" y="368" textAnchor="middle" fontFamily="monospace" fontWeight="900" fontSize={26} fill="black" style={{ textTransform: "uppercase" }}>
                                        {mockName}
                                    </text>
                                </>
                            );
                        ...
                        case 'king-of-bitcoin':
                            return (
                                <>
                                    <defs>
                                        <clipPath id={`avatar-clip-coin-${template.id}`}>
                                            <circle cx="150" cy="150" r="60" />
                                        </clipPath>
                                        <radialGradient id={`center-glow-${template.id}`}>
                                    ...
                                    <rect width="300" height="400" fill={`url(#center-glow-${template.id})`} />
