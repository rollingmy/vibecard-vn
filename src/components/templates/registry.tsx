...
export const TemplateStyles: Record<string, TemplateRenderFn> = {
    ...
    // ===================================
    'red-flag-di-dong': ({ userName, userImage, nameFontSize }) => (
        <>
            <defs>
    ...
    // ===================================
    'chua-he-biet-yeu': ({ userName, userImage, nameFontSize }) => (
        <>
            <defs>
    ...
    // ===================================
    'trap-girl-chinh-hieu': ({ userName, userImage, nameFontSize }) => (
        <>
            <defs>
    ...
    // ===================================
    'good-boy-thanh-thien': ({ userName, userImage, nameFontSize }) => (
        <>
            <defs>
    ...
    // ===================================
    'ex-files': ({ userName, userImage, nameFontSize }) => (
        <>
            <defs>
    ...
    // ===================================
    'friendzone-forever': ({ userName, userImage, nameFontSize }) => (
        <>
            <defs>
    ...
    // ===================================
    'match-tinder': ({ userName, userImage, nameFontSize }) => (
        <>
            <defs>
    ...
    // ===================================
    'le-hoi-chia-tay': ({ userName, userImage, nameFontSize }) => (
        <>
            <defs>
    ...
    // ===================================
    'crush-quoc-dan': ({ userName, userImage, nameFontSize }) => (
        <>
            <defs>
